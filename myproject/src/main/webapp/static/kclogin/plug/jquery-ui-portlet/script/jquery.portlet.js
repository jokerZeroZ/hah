...
(function($, undefined){
    $.widget("ui.portlet", {
        ...
        _createSinglePortlet: function(portlet, _ele, column, positon, pattrs) {
            ...
            if(pattrs.icon){ // 有图标才显示下面按钮 update by yin.liu 2014-02-25 
            // event element 修改刷新，关闭，放小放大处理的按钮
            // 统一待办的刷新按钮要加一个事件响应，UI中不晓得在哪里设，在这里加一个id,页面加载后再加点击方法，详见frist_portlet.jsp
            title.prepend("<div class='ui-corner-all ui-portlet-event'><span class='index_content_shuaxin ui-portlet-refresh' id='"+pattrs.attrs.id+"_shuaxin'><a></a></span></div>");
            title.prepend("<div class='ui-corner-all ui-portlet-event'><span class='index_content_jian ui-portlet-toggle'><a></a></span></div>");
            title.prepend("<div class='ui-corner-all ui-portlet-event'><span class='index_content_guanbi ui-portlet-close'><a></a></span></div>");
            }
            // content
            var ct = $('<div/>', {
        ...
        _initEvents: function(element) {
            ...
            // toggle contents  加减按钮的处理  2014-1-24 modify
            var toggle = $(".ui-portlet-toggle", _ele).click(function(event, type) {
                ...
                if (type == 'toggle') {
                    ct.slideToggle();
                    $(this).toggleClass("index_content_jian").toggleClass("index_content_jia");
                } else if (type == 'hide') {
                    ct.slideUp();
                    $(this).removeClass("index_content_jian").addClass("index_content_jia");
                } else if (type == 'show') {
                    ct.slideDown();
                    $(this).removeClass("index_content_jia").addClass("index_content_jian");
                }
        ...
        _hoverable: function(element) {
            $(element).hover(function() {
                //$(this).addClass('ui-state-hover'); 刷新按钮放上去有问题  modify 2014-1-24 
            }, function() {
