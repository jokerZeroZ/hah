							...
							// shenliang modify start
								...
								var M = function(e, f) {
									...
									if (!a.grid.hDiv.loading) {
										...
										if (a.p.page <= 0)
											a.p.page = 1;
										if (p.search !== null
												|| (null != a.p.filterNames && a.p.filterNames.length > 0)) {
											{
												if(a.p.userFilters&&"undefined" != a.p.userFilters )
												{
													a.p.search = a.p.userFilters;
												}
												if (null != a.p.filterNames
														&& a.p.filterNames.length > 0) {
													var filterStr = "";
													for (var tff = 0; tff < a.p.filterNames.length; tff++) {
														if ((null != a.p.search
																&& "" != a.p.search && (a.p.search + '') != 'true'
																	&& (a.p.search + '') != 'false')
																|| tff != 0) {
															filterStr = filterStr
																	+ ",";
													...
													filterStr = descape(escape(filterStr));
													if ((null === a.p.search && "" === a.p.search)
															|| (a.p.search + '') == 'true'
															|| (a.p.search + '') == 'false') {
														j[p.search] = "{"
																+ filterStr
											...
											.bind(
													...
													function() {
														...
														if (f)
															...
															a.p.toppager
																	&& (!a.p.pagerinBottombar || !a.p.pagerintoolbar)
																	&& b(
																			".ui-pg-selbox",
																			a.p.toppager)
																			.val(
									...
									if (a.p.toolbar[0] === true
										...
										j[1] += b(a.grid.uDiv).height()
												...
												+ parseInt(b(a.grid.uDiv).css(
														"border-bottom-width"),
														10);
									if (a.p.toppager && (!a.p.pagerinBottombar || !a.p.pagerintoolbar))
								...
								for (k = 0; k < this.p.colNames.length; k++) {
									...
									na = a.p.colModel[k].index
											|| a.p.colModel[k].name;
									// shenliancheng modify start
									var _flagF = true
									var _idexF = 0;
									if (null != a.p.filterNames
											&& a.p.filterNames.length > 0) {
										for (i = 0; i < a.p.filterNames.length; i++) {
											if (a.p.colModel[k].name == a.p.filterNames[i]) {
												_flagF = false;
												_idexF = i;
												break;
											}
									...
									if (_flagF) {
										...
										if (null == a.p.filterOptions
												|| a.p.filterOptions.length < _idexF) {
											alert("filterOptions is null or filterOptions length < filterNames length");
											return;
										}
										var t_f_string = "<select class='title_filter_"
												+ a.p.filterNames[_idexF]
												+ "' id='tf_"
												+ a.p.filterNames[_idexF]
												+ "' >";
										var t_sd = null == a.p.filterOptionsDefValue
												|| a.p.filterOptionsDefValue.length < _idexF ? -1
												: a.p.filterOptionsDefValue[_idexF];
										for (s = 0; s < a.p.filterOptions[_idexF].length; s++) {
											t_f_string += '<option role="option" value="'
													+ a.p.filterOptions[_idexF][s][0]
													+ '"'
													+ (t_sd == s ? ' selected="selected"'
															: "")
													+ ">"

													+ a.p.filterOptions[_idexF][s][1]
													+ "</option>";
										}
										t_f_string += "</select>";
										da += t_f_string;
								...
								if (null != a.p.filterNames
										&& a.p.filterNames.length > 0) {
									for (i = 0; i < a.p.filterNames.length; i++) {
										b("#tf_" + a.p.filterNames[i]).change(
												function() {
													a.p.page = 1;
													ka();
													return false;
								...
								b(I).css("width", h.width + "px").append(
										"<div class='ui-jqgrid-resize-mark' id='rs_m"
												+ a.p.id + "'>&#160;</div>");
								if (a.p.pagerinBottombar)
									//b(I).append( //yiping.huang 去掉列表下面那一栏
											//"<div class='ui_t_bottombar_content' id='t_bottombar_content"+ a.p.id 
											//		+ "' width='" + h.width
											//		+ "px'></div>");
								...
								b("th", q)
										...
										.click(
												function(e) {
													...
													//shenliancheng modify
													// start
													if (null != a.p.filterNames
															&& a.p.filterNames.length > 0) {
														for (i = 0; i < a.p.filterNames.length; i++) {
															if (b("div", this)[0].id == 'jqgh_'
																	+ a.p.id
																	+ "_"
																	+ a.p.filterNames[i]) {
																return false;
								...
								a.updatepager = function(e, f) {
									var j, m, p, C, s, A, z, u = "", w = a.p.pager ? "_"
											...
											: "", r = a.p.toppager
											&& (!a.p.pagerinBottombar || !a.p.pagerintoolbar) ? "_"
									...
									u += a.p.toppager && (!a.p.pagerinBottombar || !a.p.pagerintoolbar) ? u ? ","
											+ a.p.toppager
											: a.p.toppager
											: "";
									if (u || a.p.pagerintoolbar||a.p.pagerinBottombar) {
										...
										if (a.p.pginput === true) {
											...
											C = a.p.toppager
													&& (!a.p.pagerinBottombar || !a.p.pagerintoolbar) ? "#sp_1"
													+ w + ",#sp_1" + r
													: "#sp_1" + w;
											b(C)
													.html(
										...
										if (a.p.viewrecords
												|| a.p.pagerintoolbar || a.p.pagerinBottombar)
											if (a.p.reccount === 0 && (!a.p.pagerinBottombar || !a.p.pagerintoolbar))
												...
												b(".ui-paging-info", u).html(
														b.jgrid.format(
																a.p.recordtext,
																C, s, A))
												var t_taoobar_string = "";
												
												/* yiping.huang 2013-11-13 modify start */
												if (a.p.toolbar.length > 2) {
													t_taoobar_string = "<table class='t_taoobar_content' width='"
															+ h.width
															+ "px'><tr><td align='left' class='t_taoobar_content_left'><div>"
															+ a.p.toolbar[2]
															+ "</div></td>"
												}

												var modthPager = function(_records, _rowNum) {
													var _t_pager_count = 0;
													if (0 != a.p.records&& _rowNum != 0) {
														_t_pager_count = parseInt(_records / _rowNum);
														_t_pager_count = _records / _rowNum > _t_pager_count ? _t_pager_count + 1: _t_pager_count;
													}
													return _t_pager_count;
												}

												var _pager_count = modthPager(a.p.records, a.p.rowNum);
												var _select_pager = function(_pager_count,idNames) {
													var t_taoobar_string = "";
													if (_pager_count > 0) {
														var pading_xuan = "";
														t_taoobar_string += "<div id='paging_down_tan_page"+a.p.jgridpagerId+"' style='display:none' class='paging_down_tan'><ul>";
														for (s = 0; s < _pager_count; s++) {
															if(a.p.page == s + 1) {
																pading_xuan = "pading_xuan1";
															} else {
																pading_xuan = "pading_xuan2";
															}
															t_taoobar_string += "<li id='goto_page_"+(s + 1)+"' page='"+(s + 1)+"'><a class='"+pading_xuan+"' href='#'>"+(s + 1)+"/"+_pager_count+"</a></li>"
														}
														t_taoobar_string += "</ul></div>";
														t_taoobar_string += "<div id='paging_digital_page"+a.p.jgridpagerId+"' class='paging_digital'>"+a.p.page+"/"+_pager_count;
														if(_pager_count > 1) {
															t_taoobar_string += "<div class='paging_down'><a href='#'></a></div>";	
														}
														t_taoobar_string += "</div>";
													} else {
														t_taoobar_string = "<div class='paging_digital'>0/0</div>";
													}
													
													
													return t_taoobar_string;
												}
												
												var _m_pager_string = function(
														idNames, isShow,bottomFlag) {
													var t_taoobar_string ="";

													if (isShow) {
														if (a.p.toolbar.length <= 2|| bottomFlag ) {
															t_taoobar_string = "<div class='paging_button'>";
														}
														
														if(bottomFlag) {
															t_taoobar_string += "<div id='_pg_up_but"+ a.p.jgridpagerId+ "' class='button_an5'><a href='#' title='上一页'></a></div>";
															t_taoobar_string += "<div id='_pg_next_but"+ a.p.jgridpagerId+ "' class='button_an6_after'><a href='#' title='下一页'></a></div>";
															t_taoobar_string += "<div id='_pg_select_but"+ a.p.jgridpagerId+ "' class='button_an7'><a href='#' title='设置列表'></a></div>";
												...
												if (a.p.toolbar.length > 2 || a.p.pagerintoolbar || a.p.pagerinBottombar) {
													t_taoobar_string += _m_pager_string('',a.p.pagerintoolbar,false);
													t_taoobar_string += "</div>";
													t_taoobar_string += "<div class='paging_button_tan'>";
													t_taoobar_string += "<ul>";
													
													for(rp = 0; rp < a.p.rowList.length; rp++) {
														t_taoobar_string += "<li class='paging_xuan1' id='paging_xuan_"+a.p.rowList[rp]+"' pageNum='10'><a href='#'>每页"+a.p.rowList[rp]+"条</a></li>";
													}
													t_taoobar_string += "</ul>";
													t_taoobar_string += "</div>";
													
													//t_taoobar_string += _select_pager(_pager_count,"bb");//yiping.huang modify 2013-11-18 去掉了这一行
													jQuery("#paging_xuan_" + a.p.rowNum).removeClass("paging_xuan1");
													jQuery("#paging_xuan_" + a.p.rowNum).addClass("paging_xuan2");
													if(a.p.pagerintoolbar){
														b(h.uDiv).html("");
														b(h.uDiv).html(t_taoobar_string);
													}
												}
												
												if (a.p.pagerinBottombar) {
													var t_bootombar_string = _m_pager_string('bb',a.p.pagerinBottombar,true);
													t_bootombar_string += "</div>";
													t_bootombar_string += "<div class='paging_button_tan' id='paging_button_tan_page"+a.p.jgridpagerId+"' style='display:none'>";
													t_bootombar_string += "<ul>";
													var paging_tui = "paging_tui2";
													for(rp = 0; rp < a.p.rowList.length; rp++) {
														if(a.p.rowNum == a.p.rowList[rp]) {
															paging_tui = "paging_tui1";
														} else {
															paging_tui = "paging_tui2";
														}
														t_bootombar_string += "<li class='paging_xuan1' id='paging_xuan_"+a.p.rowList[rp]+"' pageNum='"+a.p.rowList[rp]+"'><a class='"+paging_tui+"' href='#'>每页"+a.p.rowList[rp]+"条</a></li>";
													}
													t_bootombar_string += "</ul>";
													t_bootombar_string += "</div>";
													
													t_bootombar_string += _select_pager(_pager_count,"bb");
													//jQuery("#t_bottombar_contentgridTable").hide();
													jQuery("#"+a.p.jgridpagerId).html(t_bootombar_string);
													
													/*弹出层显示与隐藏*/
													var unCloseArray = new Array();
													var clickCloseArray = new Array();
													
													unCloseArray.push($("#paging_digital_page"+a.p.jgridpagerId)[0]);
													unCloseArray.push($("#paging_down_tan_page"+a.p.jgridpagerId)[0]);
													unCloseArray.push($("#paging_down_tan_page"+a.p.jgridpagerId+" ul")[0]);
													
													$("#paging_down_tan_page"+a.p.jgridpagerId+" li").each(function(){
														unCloseArray.push(this);
													});
													$("#paging_down_tan_page"+a.p.jgridpagerId+" li a").each(function(){
														unCloseArray.push(this);
													});
													...
													var closeCon = new PubOPT.closeControl({
														 clickId : "paging_digital_page"+a.p.jgridpagerId,
														 unCloseArray : unCloseArray,
														 clickCloseArray : clickCloseArray,
														 closeFunction : function(){
															$("#paging_down_tan_page"+a.p.jgridpagerId).fadeOut();
														}
													});
													/*弹出层显示与隐藏*/
													
												
													var unCloseArray1 = new Array();
													var clickCloseArray1 = new Array();
													
													unCloseArray1.push($("#_pg_select_but" + a.p.jgridpagerId)[0]);
													unCloseArray1.push($("#paging_button_tan_page"+a.p.jgridpagerId)[0]);
													unCloseArray1.push($("#paging_button_tan_page"+a.p.jgridpagerId+" ul")[0]);
													
													$("#paging_button_tan_page"+a.p.jgridpagerId+" li").each(function(){
														unCloseArray1.push(this);
													});
													$("#paging_button_tan_page"+a.p.jgridpagerId+" li a").each(function(){
														unCloseArray1.push(this);
													});
													
													$("#paging_button_tan_page"+a.p.jgridpagerId+" li a").each(function(){
														 clickCloseArray1.push(this);
													});
													
													var closeCon1 = new PubOPT.closeControl({
														 clickId : "_pg_select_but" + a.p.jgridpagerId,
														 unCloseArray : unCloseArray1,
														 clickCloseArray : clickCloseArray1,
														 closeFunction : function(){
															$("#paging_button_tan_page"+a.p.jgridpagerId).fadeOut();
														}
													});
													/*弹出层显示与隐藏*/
												}

												if (_pager_count > 1 || a.p.pagerintoolbar || a.p.pagerinBottombar) {
													var _fn_set_button = function(_pager_count) {
															if (a.p.page <= 1) {
																b("#_pg_up_but"+a.p.jgridpagerId).removeClass("button_an5_after");
																b("#_pg_up_but"+a.p.jgridpagerId).addClass("button_an5");
																b("#_pg_up_but"+a.p.jgridpagerId).attr("disabled","disabled");
															}
															if (a.p.page > 1) {
																b("#_pg_up_but"+a.p.jgridpagerId).removeClass("button_an5");
																b("#_pg_up_but"+a.p.jgridpagerId).addClass("button_an5_after");
																b("#_pg_up_but"+a.p.jgridpagerId).removeAttr("disabled");
															}
															if (a.p.page >= _pager_count) {
																b("#_pg_next_but"+a.p.jgridpagerId).removeClass("button_an6_after");
																b("#_pg_next_but"+a.p.jgridpagerId).addClass("button_an6");
																b("#_pg_next_but"+a.p.jgridpagerId).attr("disabled","disabled");
															}
															if (a.p.page < _pager_count) {
																b("#_pg_next_but"+a.p.jgridpagerId).removeClass("button_an6");
																b("#_pg_next_but"+a.p.jgridpagerId).addClass("button_an6_after");
																b("#_pg_next_but"+a.p.jgridpagerId).removeAttr("disabled");
															}
													}
													
													_fn_set_button(_pager_count);

													var _fn_modify_pager = function(_id, obj) {
														var _pager_count = modthPager(a.p.records,a.p.rowNum);
														var _val = -1;
														switch (_id) {
														...
														case "1":
															...
															break;
														case "2":
															_val = parseInt(a.p.page) + 1;
															break;
														case "3":
															_val = parseInt(a.p.page) - 1;
														}
														
														if (a.p.page != _val&& _val > 0 && _val <= _pager_count) {
															a.p.page = _val;
															ka();
															b(".id_pg_text").val(b.jgrid.format(a.p.pg_text|| "",a.p.records));
															b(".c_pager_toolbar_select").html("");
															//b(".c_pager_toolbar_select").html(_select_pager(_pager_count,''));//yiping.huang modify 2013-11-18 去掉了这一行
															_fn_set_button(_pager_count);
														}
														b(a).jqGrid().trigger("reloadGrid");
														return false;
													}

													if (_pager_count > 1) {
														b("#paging_down").click(function() {
															if($("#paging_down_tan_page"+a.p.jgridpagerId).is(':hidden') == true) {
																jQuery("#paging_down_tan_page"+a.p.jgridpagerId).show();
															 } else {
																 jQuery("#paging_down_tan_page"+a.p.jgridpagerId).hide();;
															 }
														});
														
														b("#paging_digital_page"+a.p.jgridpagerId).click(function() {
															if($("#paging_down_tan_page"+a.p.jgridpagerId).is(':hidden') == true) {
																jQuery("#paging_down_tan_page"+a.p.jgridpagerId).show();
															 } else {
																 jQuery("#paging_down_tan_page"+a.p.jgridpagerId).hide();;
														...
														b("#paging_down_tan_page"+a.p.jgridpagerId+" li").each(function() {
															 jQuery(this).click(function(){
																 _fn_modify_pager("1",jQuery(this).attr('page'));
															 });
														});
														
														
														b("#_pg_next_but" +a.p.jgridpagerId).click(
																function() {
																	_fn_modify_pager("2",1)
														});
														b("#_pg_up_but" + a.p.jgridpagerId).click(
																function() {
																	_fn_modify_pager("3",2)
														});
													}
													
													b("#_pg_select_but" + a.p.jgridpagerId).click(
															function() {
																if($("#paging_button_tan_page"+a.p.jgridpagerId).is(':hidden') == true) {
																	jQuery("#paging_button_tan_page"+a.p.jgridpagerId).show();
																 } else {
																	 jQuery("#paging_button_tan_page"+a.p.jgridpagerId).hide();
																 }
													});
													
													b("#paging_button_tan_page"+a.p.jgridpagerId+" li").each(function() {
															jQuery(this).click(function(){
																b(a).jqGrid().jqGrid("setGridParam",{
																	rowNum : jQuery(this).attr('pageNum')
													...
													b("#paging_xuan_" + a.p.rowNum).removeClass("paging_xuan1");
													b("#paging_xuan_" + a.p.rowNum).addClass("paging_xuan2");
												}
												/* yiping.huang 2013-11-13 end */
											}
										if (a.p.pgbuttons === true) {
											if (j <= 0)
												j = m = 0;
