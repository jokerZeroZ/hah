...
//tree
document.write("<script src='"+ProjectName+"/ccapp/oa/resources/plug/ifrom/js/ifrom-treetools.js'><\/script>");
...
document.write("<script src='"+ProjectName+"/ccapp/oa/resources/plug/JQuery zTree v3.0/js/jquery.ztree.exedit-3.0.js'><\/script>");
