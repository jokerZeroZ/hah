						...
						if (this.tagName.toUpperCase() != "TABLE")
							...
							// shenliang modify start
								...
								var M = function(e, f) {
									...
									/*var ffff=false;
									for(var ckk = 0;ckk<a.p.selarrrow.length;ckk++){
										//var model = b(a).jqGrid('getRowData',a.p.selarrrow[ckk]);
										alert(a.p.selarrrow[ckk].id)
									}*/
									a.p.selarrrow=[];
									...
									if (a.p.toolbar[0] === true
										...
										j[1] += b(a.grid.uDiv).height()
												...
												+ parseInt(b(a.grid.uDiv).css(
														"border-bottom-width"),
														10);
									if (a.p.toppager && !a.p.pagerintoolbar)
								...
								a.updatepager = function(e, f) {
									...
									u += a.p.toppager && !a.p.pagerintoolbar ? u ? ","
											+ a.p.toppager
											: a.p.toppager
											: "";
									if (u || a.p.pagerintoolbar) {
										...
										if (a.p.viewrecords
												|| a.p.pagerintoolbar)
											if (a.p.reccount === 0 && !a.p.pagerintoolbar)
												...
												/* shenliancheng modify start *//*将style='width:260px;' 改为260为了适应4按钮*/
												if (a.p.toolbar.length > 2 ) {
													t_taoobar_string = "<table class='t_taoobar_content' width='"
															+ h.width
															+ "px'><tr><td align='left' style='width:260px;'  class='t_taoobar_content_left'><div>"
															+ a.p.toolbar[2]
															+ "</div></td>"
												}

												var modthPager = function(
														_records, _rowNum) {
													var _t_pager_count = 0;
													if (0 != a.p.records
															&& _rowNum != 0) {
														_t_pager_count = parseInt(_records
																/ _rowNum);
														_t_pager_count = _records
																/ _rowNum > _t_pager_count ? _t_pager_count + 1
																: _t_pager_count;
												...
												var _pager_count = modthPager(
														a.p.records, a.p.rowNum);
												
												var _select_pager = function(
														_pager_count,idNames) {
													var t_taoobar_string = "";
													if (_pager_count > 0) {
														t_taoobar_string += "<select class='pager_toolbar_select' id='pager_toolbar_select+"
																+ idNames
																+ "'>";
														for (s = 0; s < _pager_count; s++)
															t_taoobar_string += '<option class="pager_toolbar_select_option" role="option" value="'
																	+ (s + 1)
																	+ '"'
																	+ (a.p.page == (s + 1) ? ' selected="selected"'
																			: "")
																	+ ">"
																	+ (s + 1)
																	+ "/"
																	...
																	+ a.p.pager_text;
														+"</option>";
														t_taoobar_string += "</select>";
													} else {
														t_taoobar_string = "<select><option>0/0 "+a.p.pager_text +"</option></select>";
													}
												...
												var _m_pager_string = function(
													...
													if (isShow) {
														...
														t_taoobar_string += "<td align='right' id='pager_td_topbar"
																+ idNames
																+ "'>";
														
														//t_taoobar_string += "<div class='pager_toolbar_select_div'><span  class='c_pager_toolbar_select' id='c_pager_toolbar_select"
															//+ idNames
															//+ "'>";

													
													//t_taoobar_string += _select_pager(_pager_count,idNames);

													//t_taoobar_string += "</span></div>";
														t_taoobar_string +="<div class='_pg_next_but_div'><input type='text' class='_pg_go_input' value='"+a.p.page+"'> <span class='_pg_go_a'><a> Go</a></span>&nbsp;</div>"
														t_taoobar_string+="<div class='_pg_next_but_div'><input type='button' class='_pg_go_end but_y_01' value='"+a.p.pager_end+"'></div>"
														t_taoobar_string += "<div class='_pg_next_but_div'><input type='button' id='_pg_next_but but_y_01"
														+ idNames
														+ "' class='_pg_next_but_valid _pg_next_but but_y_01' value='"
														+ a.p.pgnext
														+ "'/></div>";
													t_taoobar_string += "<div class='_pg_up_but_div '><input type='button' id='_pg_up_but"
														+ idNames
														+ "' class='_pg_up_but_valid _pg_up_but but_y_01' value='"
														+ a.p.pgup
														+ "'/></div>";
													t_taoobar_string+="<div class='_pg_next_but_div'><input type='button' class='_pg_go_first but_y_01' value='"+a.p.pager_farst+"'></div>"
														t_taoobar_string += "<div class='id_pg_text_div'>"
																+ b.jgrid
																		.format(
																				a.p.pg_text
																						|| "",
																				A)+"/"+_pager_count+a.p.pager_text
																+ "</div>";
												...
												if (a.p.toolbar.length > 2
														|| a.p.pagerintoolbar) {
													t_taoobar_string += _m_pager_string(
															'',
															a.p.pagerintoolbar,false);
													t_taoobar_string += "</tr></table>";
													b(h.uDiv).html("");
													b(h.uDiv).html(
															t_taoobar_string);
												}
												if (a.p.pagerinBottombar) {
													var t_bootombar_string = _m_pager_string(
															'bb',
															a.p.pagerinBottombar,true);
													t_bootombar_string += "</tr></table>";
													b("#t_bottombar_content"+ a.p.id )
															.html(
																	t_bootombar_string);
												}
												...
												if (_pager_count > 1
														|| a.p.pagerintoolbar
														|| a.p.pagerinBottombar) {

													var _fn_set_button = function(
															_pager_count) {
															if (a.p.page <= 1) {
																b("._pg_up_but")
																		.removeClass(
																...
																b("._pg_up_but")
																		.addClass(
																				"_pg_up_but_invalid");
																b("._pg_up_but").attr("disabled","disabled");
															...
															if (a.p.page > 1) {
																...
																b("._pg_up_but")
																		.addClass(
																				"_pg_up_but_valid");
																b("._pg_up_but").removeAttr("disabled");
															}
															if(a.p.page > 1){
																b("._pg_go_first")
																.removeClass(
														...
														b("._pg_go_first")
																.addClass(
																		"_pg_up_but_valid");
														b("._pg_go_first").removeAttr("disabled");
															}else{
																b("._pg_go_first")
																.removeClass(
																		"_pg_up_but_valid");
														b("._pg_go_first")
																.addClass(
																		"_pg_up_but_invalid");
														b("._pg_go_first").attr("disabled","disabled");
															}
														...
														b("._pg_go_end")
																.addClass(
																		"_pg_up_but_valid");
														b("._pg_go_end").removeAttr("disabled");
															}else{
																b("._pg_go_end")
																.removeClass(
																		"_pg_up_but_valid");
														b("._pg_go_end")
																.addClass(
																		"_pg_up_but_invalid");
														b("._pg_go_end").attr("disabled","disabled");
															}
															if (a.p.page >= _pager_count) {
																b(
																		"._pg_next_but")
																...
																b("._pg_next_but")
																		.addClass(
																				"_pg_up_next_invalid");
																b("._pg_next_but").attr("disabled","disabled");
															}
															if (a.p.page < _pager_count) {
																b(
																		"._pg_next_but")
																		.removeClass(
																				"_pg_next_but_invalid");
																b(
																		"._pg_next_but")
																		.addClass(
																				"_pg_up_next_valid");
																b("._pg_next_but").removeAttr("disabled");
															}
													...
													var _fn_modify_pager = function(
														...
														if (a.p.page != _val
															...
															ka();
																...
																b(
																		".c_pager_toolbar_select")
																		.html(
																				"");
																b(
																		".c_pager_toolbar_select")
																		.html(
																				_select_pager(_pager_count,''));
															_fn_set_button(_pager_count);
														}
														return false;
													}
													b("._pg_go_input").keyup(function(){
														var ppp =b(this).val();
														if(isNaN(ppp)){
															ppp=1;
														}
														b("._pg_go_input").val(ppp);
														
												    	
													});
													if (_pager_count > 1) {
														b(".pager_toolbar_select")
														.change(
																function() {
																	_fn_modify_pager(
																			"1",
														...
														b("._pg_go_a").click(function(){
															var psg=b(this).prev().val();
															if(psg > _pager_count){
																psg = _pager_count;
															}
															b("._pg_go_input").val(psg)
															_fn_modify_pager("1",psg)
														});
														b("._pg_go_first").click(function(){
															_fn_modify_pager("1",1)
														});
														b("._pg_go_end").click(function(){
															_fn_modify_pager("1",_pager_count)
														});
