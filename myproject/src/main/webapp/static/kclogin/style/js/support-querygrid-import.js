...
//会议                 css文件加载
document.write("<link href='"+ProjectName+"/ccapp/oa/resources/style/lightblue/css/global.css' rel='stylesheet' type='text/css' ><\/link>");
document.write("<link href='"+ProjectName+"/ccapp/oa/resources/style/lightblue/css/layout.css' rel='stylesheet' type='text/css' ><\/link>");
...
//grid
document.write("<script src='"+ProjectName+"/ccapp/oa/resources/plug/jquery.jqGrid-4.3.1/lightblue/js/i18n/grid.locale-en.js'><\/script>");
document.write("<script src='"+ProjectName+"/ccapp/oa/resources/plug/jquery.jqGrid-4.3.1/lightblue/js/jquery.jqGrid.min.js'><\/script>");
